...
def get_cnt_pages_list(category, amount_min=22, amount_max=4053):
    payload = PayloadBuilder().set_category(category["category_id"]).set_filters(amount_min, amount_max, category.get("special_filters")).get_payload()
...
def download_list(category, page=1, amount_min=22, amount_max=4053):
    payload = PayloadBuilder().set_category(category["category_id"]).set_page_number(page).set_filters(amount_min, amount_max, category.get("special_filters")).get_payload()
